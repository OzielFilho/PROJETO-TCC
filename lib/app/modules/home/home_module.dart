...
import 'presentation/pages/configuration_home_page.dart';
import 'presentation/pages/emergence_phones_home_page.dart';
...
import 'presentation/controllers/bloc/chat/get_list_contacts_message_bloc.dart';
  ...
  List<ModularRoute> get routes => [
        ...
        ChildRoute('/chat_with_contact_home',
            child: (context, args) => ChatWithContactPage(
                  nameUser: args.data['nameUser'],
                  nameContact: args.data['nameContact'],
