...
TextTheme textDark = TextTheme(
  caption: TextStyle(color: Colors.white, fontWeight: FontWeight.normal),
  overline: TextStyle(color: Colors.white, fontWeight: FontWeight.normal),
  ...
  subtitle1: TextStyle(color: Colors.white, fontWeight: FontWeight.normal),
  headline1:
